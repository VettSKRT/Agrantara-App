...
const CSS = `
  ...
  .land-card { transition: box-shadow .2s, transform .2s; border: 1px solid #e2e8f0; background: #fff; border-radius: 14px; overflow: hidden; display: flex; flex-direction: column; }
